...
export const projects = [
  ...
  },
  {
    ...
    description:
      'My first portfolio — minimal, fast, and framework-free. Built with pure HTML, JavaScript, and Tailwind CSS.',
    tags: ['HTML5', 'JavaScript', 'Tailwind CSS'],
    liveUrl: 'https://tawchif.vercel.app',
    githubUrl: 'https://github.com/tawchifulislam/My-Personal-Portfolio',
    featured: false,
  },
];
